...
const BarChart = ({ data, resistanceLevels, intervalPad }) => {
    ...
    // Добавление Frequent High Resistances
    ...
    return (
        <div className="chart-container">
            <Chart ref={chartRef} type="ohlc" data={chartData} options={options} />
        </div>
    );
};
